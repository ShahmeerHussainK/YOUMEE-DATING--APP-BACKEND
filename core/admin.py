...
from .models import User_Profile, User_Picture, like_and_dislike, user_block, Countries, City, UserFilterData
...
class UserFilterAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'kids', 'smoke', 'exercise', 'drink', 'height', 'city', 'country']

    class Meta:
        model = UserFilterData
        fields = '__all__'
...
admin.site.register(UserFilterData, UserFilterAdmin)
