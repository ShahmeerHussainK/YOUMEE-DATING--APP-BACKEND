...
class User_Profile(models.Model):
    ...
    remaining_days_in_exp = models.PositiveSmallIntegerField(default=2, blank=True)
...
class UserFilterData(models.Model):
    KIDS_CHOICES = (
        ('partener_kids_yes', 'Yes'),
        ('partener_kids_no', 'No')
    )
    ...
    user = models.ForeignKey(User_Profile, on_delete=models.CASCADE, related_name='user_filter_data')
    interested_age = models.CharField(max_length=100, blank=True, null=True)
    max_interested_age = models.CharField(max_length=100, blank=True, null=True)
    kids = models.CharField(max_length=100, blank=True, null=True, choices=KIDS_CHOICES)
    drink = models.CharField(max_length=100, blank=True, null=True, choices=drinkandsmoke)
    smoke = models.CharField(max_length=100, blank=True, null=True, choices=drinkandsmoke)
    relegion = models.CharField(max_length=20, blank=True, null=True, choices=religion)
    exercise = models.CharField(max_length=200, blank=True, null=True, choices=exercise)
    city = models.CharField(max_length=255, blank=True, null=True)
    country = models.CharField(max_length=255, blank=True, null=True)
    height = models.CharField(max_length=50, blank=True, null=True)
    education = models.CharField(max_length=200, choices=Education, blank=True, null=True)
    created_date = models.DateTimeField(auto_now_add=True)
    modified_date = models.DateTimeField(auto_now=True)

    def __str__(self):
        return self.user.your_name
